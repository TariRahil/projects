...
public class Driver {
    ...
    public Driver(Long userId, String firstName, String lastName, String nationalCode, String cellPhoneNumber, String machineModel, String numberPlate, String carColor, String createBy, String createDate) {
        this.userId = userId;
        this.firstName = firstName;
        this.lastName = lastName;
        this.nationalCode = nationalCode;
    ...
    public static Driver ToDriver(JSONObject obj)throws JSONException {
        Driver result = new Driver(obj.getLong(KEY_UserID),obj.getString(KEY_FirstName),obj.getString(KEY_LastName),
